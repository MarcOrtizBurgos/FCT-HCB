...
public class Penjat {
    ...
    private static String username = "", passwd = "", tryedLetters, rightLetters;
    ...
    public static void main(String[] args) throws InterruptedException, ExecutionException {
        ...
        do {
            ...
            updateLettersNumErrors(errors, tryedLetters, rightLetters);
            ...
            do {
                ...
                // if user hits all the letter, it will be shown a congratulations message
                    ...
                    if (repeatedLetter(letter, getTryedLetters())) {
                        ...
                        updateRightLetter(rightLetters);
    ...
    private static void updateRightLetter(String rightLetters){
        DocumentReference docRef = db.collection("joc").document(username);
        Map<String, Object> data = new HashMap<>();
        data.put("rightLetters", rightLetters);
        docRef.update(data);
        
        //return docRef;
    }
    
    private static void updateLettersNumErrors(int numErrors, String tryedLetters, String rightLetters){
        DocumentReference docRef = db.collection("joc").document(username);
        Map<String, Object> data = new HashMap<>();
        data.put("tryedLetters", tryedLetters);
        data.put("rightLetters", rightLetters);
    ...
    private static boolean startedGame() throws InterruptedException, ExecutionException{
        ...
        if (readGame().get("started").equals(true)) {
            startedGame = true;
        }else{
            startedGame = false;
        }
